    ...
    <div className="ml3">
      <h2 className="h1">Privacy Policy</h2>
        ...
        <p className="max-width-3">
          Protecting the privacy and security of individuals’ personal information is very important to us.  We do not collect any information that directly identifies you when you visit the OMB Policy Library unless you choose to provide that information by contacting us.  However, the website may collect a limited amount of information about your visit for the purposes of website analytics and customization.  Please read this notice to understand what we do with the limited amount of information about your visit that we may collect.
        </p>

        <h4>Information Collected and Stored Automatically</h4>
        <p className="max-width-3">
          As with many Federal Government websites, the OMB Policy Library is hosted by the U.S. General Services Administration (GSA).  GSA, or contractors working on behalf of GSA, collect limited information about visits to the OMB Policy Library.  This information is used to measure the number of visitors to the various sections of our website and to identify performance or problem areas.  Authorized individuals may also use this information to help us develop the site, analyze patterns of usage, and to make the site more useful.  We do not share or sell visitor data for the purposes of advertising, marketing, or any other commercial purpose.  This information is not used for associating search terms or patterns of site navigation with individual users.  The information that is automatically collected and stored concerning your visit includes:
        ...
        <p className="max-width-3">
          ...
          Here is how it works: Google Analytics sets one or more cookies on your computer so that it can recognize your computer if you visit the the OMB Policy Library website in the future. This cookie(s) does not collect personally identifiable information. This is considered a Tier 2 usage, as defined in the OMB guidance.
          ...
          Visitors who choose to disable this web measurement tool will still have full access to the OMB Policy Library.  While the details vary from browser to browser, most modern browsers can be set up to accept, reject, or request user intervention when a site asks to set a cookie.
        ...
        <p className="max-width-3">
          ...
          In addition, the security policy of Sites provides that “[u]nauthorized attempts to upload information or change information on this service are strictly prohibited and may be punishable under the Computer Fraud and Abuse Act of 1986 and the National Information Infrastructure Protection Act.”

          We encourage you to visit Sites if you have additional questions about the government-hosted service.
        </p>
